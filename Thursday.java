...
public class Thursday extends AppCompatActivity {
    ...
    private static Button button_thurs;
    Button btnviewAll;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnviewAll = (Button)findViewById(R.id.view4);
        viewAllMethod();
    }
    public void OnClickButtonListener(){
        button_thurs = (Button)findViewById(R.id.thursadd);
        button_thurs.setOnClickListener(
                new View.OnClickListener(){
                    public void onClick(View v){
                        Intent intent =new Intent("com.example.sravyanaguboyina.timetable.thurs_addclass");
