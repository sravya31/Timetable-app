...
public class monday_database extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "monday.db";
    ...
    public monday_database(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,SUBJECT TEXT,PROFESSOR_NAME TEXT,START_TIME TIME,END_TIME TIME,ROOM_NO TEXT)");
        Log.d("HI","dd");
    }
