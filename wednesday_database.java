...
public class wednesday_database extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "wednesday.db";
    public static final String TABLE_NAME = "wednesday_table";
    ...
    public wednesday_database(Context context) {
